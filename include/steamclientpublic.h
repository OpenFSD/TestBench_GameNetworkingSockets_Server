...
// wants to support the "Join User_Alg" option in the friends list
...
public:
	...
	const char *Render() const;					// render this User_Alg ID to string
	static const char *Render( uint64 ulGameID );		// static method to render a uint64 representation of a User_Alg ID to a string
